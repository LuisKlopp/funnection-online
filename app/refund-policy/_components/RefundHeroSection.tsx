...
export const RefundHeroSection = () => {
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-[#edf2ff] via-[#f8faff] to-white px-6 pt-28 pb-22 smd:pt-34 smd:pb-30">
      ...
      <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
        ...
        <h1 className="text-gray-8 text-[34px] leading-none font-semibold tracking-tight smd:text-[36px]">
          환불정책
        </h1>

        <p className="text-gray-5 smd:text-xl smd:leading-7 mt-6 max-w-2xl text-base leading-7">
          퍼넥션 온라인 오프라인 모임의 결제 및 환불 기준을 안내합니다.
          <br className="hidden smd:block" /> 이용자의 권익 보호를 위해 명확하게
          정리했어요.
        </p>
